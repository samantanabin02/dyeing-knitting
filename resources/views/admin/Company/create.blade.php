    ...
    <section class="content">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Create Company <small class="text-red">* Fields are mendatory </small></h3>
        ...
        <div class="box-body">
			<div class="row">
			{{ Form::open(['url' => 'admin/company', 'method' => 'POST', 'files' => true, 'class' => '', 'id' => 'form-addedit','enctype' => 'multipart/form-data']) }}
                <div class="col-md-12">
                    <div class="col-md-6">
