    ...
    <ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
        ...
        <li>
            ...
            <ul class="sub-menu">
            	<li>
                    <a href="javascript:;">
                        <i class="fa fa-file-text"></i> Task category
                        <span class="arrow">
                        </span>
                    </a>
                    <ul class="sub-menu">
                <li>
                    <a href="{{ URL::to('admin/task-categories') }}">
                    	<i class="fa fa-list"></i>List View
                    </a>
                </li>
                <li>
                    <a href="{{ URL::to('admin/task-categories/create') }}">
                ...
                <li>
                    <a href="javascript:;">
                        <i class="fa fa-file-text"></i> Tasks
                        <span class="arrow">
                        </span>
                    </a>
                    <ul class="sub-menu">
                ...
                <li>
                    <a href="{{ URL::to('admin/tasks/create') }}">
                        <i class="fa fa-plus"></i>Add New
                    </a>
                </li>
            </ul>
