  ...
  <div class="row">
    <div class="col-xs-12 clearfix">
      <div class=" row form-group">
        {{ Form::open(['route' => 'unittype-index', 'method' => 'post', 'class' => '', 'id' => 'form-search']) }}
            ...
            <div class="col-md-1 col-xs-6 mrgb">
            <a href="{{ route('unittype.index') }}" id="cancel-btn" class="form-control btn btn-warning btn-block-xs">Reset</a>
            </div>
        {{ Form::close() }}
        <div class="col-md-2 col-xs-6 mrgb" >
          {{ Form::open(['route' => ['unittype-delete'], 'method' => 'post', 'id' => 'multi_delete_form', 'class' => '']) }}
        ...
        <div class="col-md-2 col-xs-6 mrgb" style="float:right;">
          <a href="{{ route('unittype.create') }}" class="form-control btn btn-info">Create New</a>
        </div>
      </div>
      @if (count($errors) > 0)
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              if (!empty($datums)) {
                  ...
                  ?>
                    <tr>
                      <td>{{ Form::checkbox('single_check',$data->unit_type_id,null, array('id'=>'single_check','class'=>'single_check')) }}</td>
                      <td>{{ $data->unit_type_name }}</td>
                      <td>{{ $data->unit_type_price }}</td>
                      <td>
                        <a style="margin-right: 10px; font-size: 16px;" href="{{ route('unittype.edit',  $data->unit_type_id) }}" title="Edit">
                           <i class="fa fa-edit"></i>
                        </a>
                        <a style="font-size: 16px;" href="#myModal" data-toggle="modal"  title="Delete">
                          <i class="fa fa-trash"> </i>
                        </a>
                        {{ Form::open(['route' => ['unittype.destroy', $data->unit_type_id], 'class' => 'form-horizontal', 'id' => "delete-form" ]) }}
