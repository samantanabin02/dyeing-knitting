    ...
    <div class="col-xs-12 clearfix">
      <div class=" row form-group">
        {{ Form::open(['route' => 'items-index', 'method' => 'post', 'class' => '', 'id' => 'form-search']) }}
            ...
            {{ Form::select('item_type', $item_types , request()->input('item_type'), ['placeholder' => 'Select item Type', 'id' => 'item_type', 'class' => 'form-control select2']) }}
            </div>
            ...
            <div class="col-md-1 col-xs-6 mrgb">
            <a href="{{ route('items.index') }}" id="cancel-btn" class="form-control btn btn-warning btn-block-xs">Reset</a>
            </div>
        {{ Form::close() }}
        <div class="col-md-2 col-xs-6 mrgb" >
          {{ Form::open(['route' => ['items-delete'], 'method' => 'post', 'id' => 'multi_delete_form', 'class' => '']) }}
        ...
        <div class="col-md-2 col-xs-6 mrgb" style="float:right;">
          <a href="{{ route('items.create') }}" class="form-control btn btn-info">Create New</a>
        </div>
      </div>
      @if (count($errors) > 0)
                  ...
                  foreach ($datums as $data) {
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        {{ Form::open(['route' => ['items.destroy', $data->id], 'class' => 'form-horizontal', 'id' => "delete-form" ]) }}
