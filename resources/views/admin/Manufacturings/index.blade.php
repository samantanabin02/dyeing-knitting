    ...
    <div class="col-xs-12 clearfix">
      <div class=" row form-group">
        {{ Form::open(['route' => 'manufacturings-index', 'method' => 'post', 'class' => '', 'id' => 'form-search']) }}
            ...
            <div class="col-md-1 col-xs-6 mrgb">
            <a href="{{ route('manufacturings.index') }}" id="cancel-btn" class="form-control btn btn-warning btn-block-xs">Reset</a>
            </div>
        {{ Form::close() }}
        <div class="col-md-2 col-xs-6 mrgb" >
          {{ Form::open(['route' => ['manufacturings-delete'], 'method' => 'post', 'id' => 'multi_delete_form', 'class' => '']) }}
