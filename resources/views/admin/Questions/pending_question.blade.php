                ...
                <div class="portlet-body form">
                    ...
                    {{ Form::open(['route' => 'questions.index', 'method' => 'get', 'class' => '', 'id' => 'form-search']) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1 col-xs-6 mrg">
                            <a href="{{ route('questions.index') }}" id="cancel-btn" class="btn btn-warning btn-block-xs"><i class="fa fa-refresh"></i></a>
                            </div>
                        ...
                        @if (count($datums)>0)
                            ...
                            @foreach ($datums as $data)
                                ...
                                <tr>
                                    ...
                                    <a href="{{ url('admin/questions-deactivate',  $data->id) }}" class="btn btn-warning">Reject</a>
                                   ...
                                   <!--  <a href="{{ route('users.edit',  $data->id) }}" class=""><i class="fa  fa-edit"></i></a> -->

                                    <a href="{{ route('questions.show',  $data->id) }}" class=""><i class="fa fa-list-alt"></i></a>

                                   <!--  <a href="{{ url('admin/questions-activate',  $data->id) }}" class=""><i class="fa fa-check"></i></a> -->

                                    <!--  <a href="{{ route('questions.show',  $data->id) }}" class=""><i class="fa fa-times"></i></a> -->
