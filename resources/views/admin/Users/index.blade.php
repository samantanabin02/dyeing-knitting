              ...
              if (!empty($datums)) {
                  foreach ($datums as $data) {
                    ...
                    <tr>
                      ...
                      <td>
                        <a style="margin-right: 10px; font-size: 16px;" href="{{ route('users.edit',  $data->id) }}" title="Edit">
                           <i class="fa fa-edit"></i>
                        </a>
                        <a style="font-size: 16px;" href="#myModal" data-toggle="modal"  title="Delete">
                          <i class="fa fa-trash"> </i>
                        </a>
                        {{ Form::open(['route' => ['users.destroy', $data->id], 'class' => 'form-horizontal', 'id' => "delete-form" ]) }}
