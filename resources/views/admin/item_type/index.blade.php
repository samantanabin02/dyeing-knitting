  ...
  <div class="row">
    <div class="col-xs-12 clearfix">
      <div class=" row form-group">
        {{ Form::open(['route' => 'itemtype-index', 'method' => 'post', 'class' => '', 'id' => 'form-search']) }}
            ...
            <div class="col-md-1 col-xs-6 mrgb">
            <a href="{{ route('itemtype.index') }}" id="cancel-btn" class="form-control btn btn-warning btn-block-xs">Reset</a>
            </div>
        {{ Form::close() }}
        <div class="col-md-2 col-xs-6 mrgb" >
          {{ Form::open(['route' => ['itemtype-delete'], 'method' => 'post', 'id' => 'multi_delete_form', 'class' => '']) }}
        ...
        <div class="col-md-2 col-xs-6 mrgb" style="float:right;">
          <a href="{{ route('itemtype.create') }}" class="form-control btn btn-info">Create New</a>
        </div>
      </div>
      @if (count($errors) > 0)
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              if (!empty($datums)) {
                  ...
                  ?>
                    <tr>
                      <td>{{ Form::checkbox('single_check',$data->item_type_id,null, array('id'=>'single_check','class'=>'single_check')) }}</td>
                      <td>{{ $data->item_type_name }}</td>
                      <td>
                        <a style="margin-right: 10px; font-size: 16px;" href="{{ route('itemtype.edit',  $data->item_type_id) }}" title="Edit">
                           <i class="fa fa-edit"></i>
                        </a>
                        <a style="font-size: 16px;" href="#myModal" data-toggle="modal"  title="Delete">
                          <i class="fa fa-trash"> </i>
                        </a>
                        {{ Form::open(['route' => ['itemtype.destroy', $data->item_type_id], 'class' => 'form-horizontal', 'id' => "delete-form" ]) }}
